...
Route::group(['middleware' => 'auth'], function () {
    Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function () {
        ...
        Route::get('users/{user}/list', 'Admin\UserController@list')->name('admin.users.list');
        Route::get('user/search/{search?}', 'Admin\UserController@search')->name('admin.users.search');
